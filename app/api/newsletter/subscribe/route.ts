...
const NICHE = 'direct-primary-care' as const
const DIRECTORY_SLUG = 'direct-primary-care-directory' as const
const NEWSLETTER_NAME = 'The Direct Care Footnote' as const
const CONFIRM_URL_BASE = 'https://www.directprimarycarefinder.com/newsletter/confirm'
